...
<body class="bg-slate-100 p-10 font-sans"><div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-4 gap-6 mb-8">
        <div class="bg-white p-6 rounded-2xl shadow-sm border-b-4 border-blue-500"><p class="text-xs font-bold text-slate-400 uppercase mb-1">Decisions</p><p class="text-4xl font-black text-slate-800">{decisions}</p></div>
        <div class="bg-white p-6 rounded-2xl shadow-sm border-b-4 border-indigo-500"><p class="text-xs font-bold text-slate-400 uppercase mb-1">Archive Density</p><p class="text-4xl font-black text-slate-800">{archive_count}</p></div>
        <div class="bg-white p-6 rounded-2xl shadow-sm border-b-4 border-orange-500"><p class="text-xs font-bold text-slate-400 uppercase mb-1">Parked Logic</p><p class="text-4xl font-black text-slate-800">{parked_count}</p></div>
        <div class="bg-white p-6 rounded-2xl shadow-sm border-b-4 border-red-500"><p class="text-xs font-bold text-slate-400 uppercase mb-1">Amnesia Events</p><p class="text-4xl font-black text-slate-800">{amnesia_count}</p></div>
    </div>

    <div class="grid grid-cols-3 gap-8">
        <div class="space-y-8">
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden border"><div class="p-4 border-b bg-slate-50 font-black text-xs uppercase tracking-wider">Sync Timeline</div><div class="p-2">{sync_html}</div></div>
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden border"><div class="p-4 border-b bg-slate-50 font-black text-xs uppercase tracking-wider">Tool Efficacy</div><div class="p-2">{usage_html}</div></div>
        </div>
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden border col-span-1"><div class="p-4 border-b bg-orange-50 font-black text-xs uppercase tracking-wider text-orange-700">Parked Logic (Reinstatement Ready)</div><div>{parked_html}</div></div>
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden border col-span-1"><div class="p-4 border-b bg-red-50 font-black text-xs uppercase tracking-wider text-red-700">Amnesia Audit</div><div>{amnesia_html}</div></div>
    </div>
</div></body></html>"""
